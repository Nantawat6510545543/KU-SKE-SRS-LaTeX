...
\begin{itemize}
    ...
    \item \textbf{PredictionModel:} Maps ITI-derived steady-state features to RT and accuracy as regression targets.
...
\begin{enumerate}
    ...
    \item Train the model on CCD-ITI to predict RT/accuracy.
