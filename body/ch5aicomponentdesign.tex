...
\begin{itemize}
    \item \textbf{RT regression:} MAE and MSE.
    \item \textbf{Correctness classification:} accuracy, F1-score, precision, and recall.
\end{itemize}
In addition to metrics, the evaluation includes qualitative checks (prediction vs. ground truth plots, error distribution summaries) to support interpretation.
...
\begin{figure}[H]
    ...
    \caption{Training Interface – Dataset selection, model configuration, and training log}
...
\begin{figure}[H]
    ...
    \caption{Prediction Interface – Uploading input data and viewing predicted RT and accuracy}
...
\begin{figure}[H]
    ...
    \caption{Comparison Interface – Visual comparison between model configurations}
