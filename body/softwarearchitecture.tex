...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{examples/domain-model-eeg.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{examples/design-class-diagram-eeg.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{examples/sequence-diagram-ssl-eeg.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{examples/ssl-architecture-eeg.png}
