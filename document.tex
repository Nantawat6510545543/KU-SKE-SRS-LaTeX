...
\def \srsTitle{\textbf{Self-Supervised Learning for EEG-Based Motor Imagery Classification(Progress Report)}}
...
\begin{document}
    ...
    \include{body/ch6deliverable}
    \include{body/ch7discussion}
    %% Chapters section
